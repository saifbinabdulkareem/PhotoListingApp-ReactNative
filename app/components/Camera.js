...
export default class CameraEx extends React.Component {
    ...
    //                 <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: 'dodgerBlue', width: 30, height: 30, borderRadius: 100, }} onPress={() => this.zoomOut()} >
    //                     <Text style={{
    //                         fontSize: 30,
    //                         textAlign: 'center',
    //                         color: 'black',
    ...
    //                 <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: 'dodgerBlue', width: 30, height: 30, borderRadius: 100, }} onPress={() => this.zoomIn()}>
    //                     <Text style={{
    //                         fontSize: 30,
    //                         textAlign: 'center',
    //                         color: 'black',
